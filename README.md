...
- **Gender-Precise Routing**: In Indian cultures, relationships are gender-specific. The kinship engine determines exact lineage (e.g., distinguishing between a _Dada_ [Father's Father] and _Nana_ [Mother's Father], or _Kaka_ [Father's Brother] and _Mama_ [Mother's Brother]).
